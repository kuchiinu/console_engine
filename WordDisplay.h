...
void WordDisplay_SetWord(WordDisplay* input_WordDisplay, const char* input_word);//文字列のセット
void WordDisplay_SetPosition(WordDisplay* input_WordDisplay, int input_x, int input_y);//文字列表示の移動
void WordDisplay_SetColor(WordDisplay* input_WordDisplay,
	int font_color, int background_color);//文字列の色の設定

void WordDisplay_draw(WordDisplay* input_WordDisplay);//文字列の描画