...
//文字列のセット
void WordDisplay_SetWord(WordDisplay* input_WordDisplay, const char* input_word)
{
	//引数から文字列とそれを表示する位置を設定する
	input_WordDisplay->word = input_word;
...
//文字列表示の移動
void WordDisplay_SetPosition(WordDisplay* input_WordDisplay, int input_x, int input_y)
{
	//オブジェクトに反映する
...
//文字列の描画
void WordDisplay_draw(WordDisplay* input_WordDisplay)
{
	//オブジェクトの描画
