...
//数字表示の初期化
void NumberDisplay_init(NumberDisplay* input_NumberDisplay, int input_number, int input_x, int input_y)
{
	//初期設定
...
//数字のセット
void NumberDisplay_SetNumber(NumberDisplay* input_NumberDisplay, int input_number)
{
	//引数から新しい数字を決定
...
//数字表示の移動
void NumberDisplay_SetPosition(NumberDisplay* input_NumberDisplay, int input_x, int input_y)
{
	//オブジェクトに反映する
...
//数字の描画
void NumberDisplay_draw(NumberDisplay* input_NumberDisplay)
{
	//オブジェクトの描画
...
//桁数の取得
int NumberDisplay_GetDiget(NumberDisplay* input_NumberDisplay)
{
