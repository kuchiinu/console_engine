...
//オブジェクトの初期化
void Object_init(Object* input_Object, int input_width, int input_height, int input_x, int input_y)
{
	//初期設定
...
//オブジェクトの移動
void Object_SetPosition(Object* input_Object, int input_x, int input_y)
{
...
//オブジェクトの色の設定
void Object_SetColor(Object* input_Object, int font_color, int background_color)
{
...
//オブジェクトの描画
void Object_draw(Object* input_Object)
{
	DrawManager* pDrawManager = GetActiveDrawManager();//コンソールと描画機能を取得
